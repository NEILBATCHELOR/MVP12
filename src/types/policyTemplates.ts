...
import { PolicyTemplateTable } from './database';
 ...
 * Extends the database PolicyTemplateTable but overrides the template_data type
 */
export interface PolicyTemplateWithData extends Omit<PolicyTemplateTable, 'template_data'> {
