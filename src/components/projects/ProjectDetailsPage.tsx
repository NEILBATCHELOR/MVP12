...
import { ProjectUI } from "@/types/centralModels";
              ...
              <CardContent>
                <dl className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <dd className="mt-1">${project.sharePrice || "N/A"}</dd>
                  </div>
                  <div>
                  ...
                  <div>
                    <dt className="text-sm font-medium text-muted-foreground">Funding Round</dt>
                    <dd className="mt-1">{project.fundingRound || "N/A"}</dd>
                  </div>
                  <div>
