...
import { savePolicy, getAllPolicies } from "@/services/enhancedPolicyService";
import { Policy } from "@/services/policyService";
import { savePolicyTemplate } from "@/services/policyTemplateService";
import { getAllPolicyTemplates, toggleTemplateStatus } from "@/services/enhancedPolicyTemplateService";
...
const RuleManagementDashboard = () => {
  ...
  // Fetch policy templates when component mounts
  useEffect(() => {
    ...
    if (user) {
      ...
      const fetchPendingCount = async () => {
        try {
          ...
          const { getPendingApprovalsForUser } = await import("../../services/approvalService");
