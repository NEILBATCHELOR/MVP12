...
import { InvestorStatus } from '@/types/centralModels';
import type { 
  InvestorInsert, 
  InvestorUpdate, 
...
import { mapInvestorFromDatabase, mapInvestorToDatabase, mapInvestorApprovalFromDatabase, mapInvestorApprovalToDatabase } from '@/utils/typeMappers';
