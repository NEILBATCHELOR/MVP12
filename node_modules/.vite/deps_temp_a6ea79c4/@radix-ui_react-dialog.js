...
import {
  ...
  useMergeRefs,
  zeroRightClassName
} from "./chunk-3OWIFKF2.js";
import {
  useEscapeKeydown
} from "./chunk-YBME2IN3.js";
import {
  useId
} from "./chunk-FKI5AZRH.js";
import {
  useControllableState
} from "./chunk-KXFVB3KF.js";
import {
  useCallbackRef,
  useLayoutEffect2
} from "./chunk-P2EZOFUQ.js";
import {
  require_react_dom
} from "./chunk-DCI7BN5X.js";
import {
  require_jsx_runtime
...
function useComposedRefs3(...refs) {
  return React7.useCallback(composeRefs3(...refs), refs);
}
...
var Slot2 = React8.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime5.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children: React8.isValidElement(newElement) ? React8.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime5.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children });
});
Slot2.displayName = "Slot";
var SlotClone2 = React8.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable2(child) {
  return React8.isValidElement(child) && child.type === Slottable2;
}
...
var Slot3 = React12.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime8.jsx)(SlotClone3, { ...slotProps, ref: forwardedRef, children: React12.isValidElement(newElement) ? React12.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime8.jsx)(SlotClone3, { ...slotProps, ref: forwardedRef, children });
});
Slot3.displayName = "Slot";
var SlotClone3 = React12.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable3(child) {
  return React12.isValidElement(child) && child.type === Slottable3;
}
...
var Slot4 = React16.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime11.jsx)(SlotClone4, { ...slotProps, ref: forwardedRef, children: React16.isValidElement(newElement) ? React16.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime11.jsx)(SlotClone4, { ...slotProps, ref: forwardedRef, children });
});
Slot4.displayName = "Slot";
var SlotClone4 = React16.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable4(child) {
  return React16.isValidElement(child) && child.type === Slottable4;
}
...
// node_modules/@radix-ui/react-dialog/node_modules/react-remove-scroll/dist/es2015/index.js
...
var RemoveScroll = React19.forwardRef(function(props, parentRef) {
  ...
  return React19.createElement(
    React19.Fragment,
    null,
    enabled && React19.createElement(SideCar, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
function RemoveScrollSideCar(props) {
  ...
  var Style = React20.useState(styleSingleton)[0];
  ...
  return React20.createElement(
    React20.Fragment,
    null,
    inert ? React20.createElement(Style, { styles: generateStyle(id) }) : null,
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime13.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React23.Children.map(children, (child) => (0, import_jsx_runtime13.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime13.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlayImpl = React23.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      (0, import_jsx_runtime13.jsx)(Combination_default, { as: Slot4, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime13.jsx)(
        Primitive4.div,
        {
          "data-state": getState(context.open),
          ...overlayProps,
