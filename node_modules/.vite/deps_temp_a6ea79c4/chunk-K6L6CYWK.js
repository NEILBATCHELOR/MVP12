...
var require_cfb = __commonJS({
  "node_modules/browserify-aes/modes/cfb.js"(exports) {
    ...
    function encryptStart(self, data, decrypt) {
      ...
      self._prev = Buffer2.concat([self._prev, decrypt ? data : out]);
      return out;
    }
    exports.encrypt = function(self, data, decrypt) {
      ...
      while (data.length) {
        if (self._cache.length === 0) {
          ...
          self._prev = Buffer2.allocUnsafe(0);
        }
        if (self._cache.length <= data.length) {
          len = self._cache.length;
          out = Buffer2.concat([out, encryptStart(self, data.slice(0, len), decrypt)]);
          data = data.slice(len);
        } else {
          out = Buffer2.concat([out, encryptStart(self, data, decrypt)]);
          break;
        }
      }
      return out;
...
var require_authCipher = __commonJS({
  "node_modules/browserify-aes/authCipher.js"(exports, module) {
    ...
    function calcIv(self, iv, ck) {
      if (iv.length === 12) {
        self._finID = Buffer2.concat([iv, Buffer2.from([0, 0, 0, 1])]);
      ...
      var out = Buffer2.from(self._finID);
      incr32(out);
      return out;
    }
...
export {
  require_modes,
  require_evp_bytestokey,
  require_browser
};
//# sourceMappingURL=chunk-K6L6CYWK.js.map
